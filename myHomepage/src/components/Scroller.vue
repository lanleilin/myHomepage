  ...
  <div class="scroller">
    ...
    <div class="content" >
      ...
      <ul class="onlyString" v-if="type === 'onlyString'">
        <li v-for="item in items"  :style="{color: item.color}">
...
export default {
  ...
  methods:{
  	say:function(){
  		console.log('here you scroll');
  		var scrollUl=document.getElementsByClassName('hasCover')[0].children;
  		var ulDis=scrollUl[2].clientLeft;
//		console.log(ulDis)
  	}
  }
}
